...
relaxBtn.addEventListener('click', () => {
    audio.src = './music/assests/relax.mp3';
    audio.play();
});

romanticBtn.addEventListener('click', () => {
    audio.src = './music/assests/romantic.mp3';
    audio.play();
});
sadBtn.addEventListener('click', () => {
  audio.src = './music/assests/sad.mp3';
  audio.play();
});
  
hopefulBtn.addEventListener('click', () => {
  audio.src = './music/assests/hopeful.mp3';
  audio.play();
});
happyBtn.addEventListener('click', () => {
  audio.src = './music/assests/happy.mp3';
  audio.play();
});
